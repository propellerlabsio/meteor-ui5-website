...
sap.ui.define(['jquery.sap.global', 'sap/ui/model/TreeBinding'],
  function(jQuery, TreeBinding) {
     ...
     */
    FlatJSONTreeBinding.prototype.getRootContexts = function(iStartIndex, iLength) {
      if (!iStartIndex) {
        iStartIndex = 0;
      }
      if (!iLength) {
     ...
     */
    FlatJSONTreeBinding.prototype._setLengthCache = function(sKey, iLength) {
     ...
     *
     */
    FlatJSONTreeBinding.prototype.checkUpdate = function(bForceupdate) {
      // apply filter again
      this.applyFilter();
      this._mLengthsCache = {};
      this._fireChange();
     ...
     */
    FlatJSONTreeBinding.prototype._applySorter = function(aContexts) {
      var that = this;
     ...
     * @protected
     */
    FlatJSONTreeBinding.prototype.getNodeContexts = function(oContext, iStartIndex, iLength) {
      if (!iStartIndex) {
        iStartIndex = 0;
      }
      if (!iLength) {
     ...
     * @public
     */
    FlatJSONTreeBinding.prototype.hasChildren = function(oContext) {
     ...
     */
    FlatJSONTreeBinding.prototype._sanitizePath = function(sContextPath) {
     ...
     * @override
     */
    FlatJSONTreeBinding.prototype.getChildCount = function(oContext) {
     ...
     * @public
     */
    FlatJSONTreeBinding.prototype.filter = function(aFilters, sFilterType) {
     ...
     * @private
     */
    FlatJSONTreeBinding.prototype.applyFilter = function() {
    ...
    FlatJSONTreeBinding.prototype._saveSubContext = function(oNode, aContexts, sContextPath, sName) {
     ...
     * @public
     */
    FlatJSONTreeBinding.prototype.sort = function(aSorters) {
      aSorters = aSorters || [];
     ...
     * @private
     */
    FlatJSONTreeBinding.prototype._applyFilterRecursive = function(oParentContext) {
