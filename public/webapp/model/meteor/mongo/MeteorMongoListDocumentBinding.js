...
sap.ui.define([
  ...
  /**
   * Constructor for MeteorMongoListDocumentBinding
   *
   * @class
   * The MeteorMongoListDocumentBinding is a specific binding for lists in the model, which can be used
   ...
   *
   * @public
   * @alias meteor-ui5-mongo.MeteorMongoListDocumentBinding
   * @extends sap.ui.model.Binding
   */
  var MeteorMongoListDocumentBinding = ListBinding.extend("meteor-ui5-mongo.MeteorMongoListDocumentBinding", {
  ...
  MeteorMongoListDocumentBinding.prototype._runQuery = function() {
   ...
   * to unexpected side effects. For avoidance use {@link meteor-ui5-mongo.MeteorMongoListDocumentBinding.prototype.getCurrentContexts}
   * instead.
   *
   * @function
   * @name meteor-ui5-mongo.MeteorMongoListDocumentBinding.prototype.getContexts
   ...
   * @protected
   */
  MeteorMongoListDocumentBinding.prototype.getContexts = function(iStartIndex, iLength) {
  ...
  MeteorMongoListDocumentBinding.prototype.destroy = function() {
   ...
   *
   * @function
   * @name meteor-ui5-mongo.MeteorMongoListDocumentBinding.prototype.filter
   * @param {object[]} aFilters Array of filter objects
   * @param {sap.ui.model.FilterType} sFilterType Type of the filter which should be adjusted, if it is not given, the standard behaviour applies
   * @return {meteor-ui5-mongo.MeteorMongoListDocumentBinding} returns <code>this</code> to facilitate method chaining
   *
   * @public
   */
   ...
   *
   * @function
   * @name meteor-ui5-mongo.MeteorMongoListDocumentBinding.prototype.sort
   * @param {sap.ui.model.Sorter|Array} aSorters the Sorter object or an array of sorters which defines the sort order
   * @return {meteor-ui5-mongo.MeteorMongoListDocumentBinding} returns <code>this</code> to facilitate method chaining
   * @public
   */
  MeteorMongoListDocumentBinding.prototype.sort = function(aSorters) {
   ...
   * @public
   */
  MeteorMongoListDocumentBinding.prototype.getCurrentContexts = function() {
   ...
   * @public
   */
  MeteorMongoListDocumentBinding.prototype.getLength = function() {
   ...
   * @public
   */
  MeteorMongoListDocumentBinding.prototype.isLengthFinal = function() {
   ...
   * @public
   */
  MeteorMongoListDocumentBinding.prototype.getDistinctValues = function(sPath) {
   ...
   * @private
   */
  MeteorMongoListDocumentBinding.prototype.enableExtendedChangeDetection = function(bDetectUpdates, vKey) {
  ...
  return MeteorMongoListDocumentBinding;
